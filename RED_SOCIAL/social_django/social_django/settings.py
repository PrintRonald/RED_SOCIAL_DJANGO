...
SECRET_KEY = 'django-insecure-nrri@3d^#hadl!h+8c(9$5-d!c_@&3#05m43-zg6hc!p+mc_df'
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize', # ME SIRVE PARA PODER NOTIFICAR EL TIEMPO DESDE QUE HICE UUN POST (hace un min, una hora, una semana)
